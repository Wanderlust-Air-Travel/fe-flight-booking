...
export const VALIDATION_MESSAGES = {
	AUTH: {
		...
		PASSWORD_TOO_WEAK: 'Mật khẩu quá yếu. Vui lòng sử dụng ít nhất 6 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt',
 ...
 */
export const VIETNAMESE_PHONE_REGEX = /^(0|84)(3[2-9]|5[6|8|9]|7[0|6-9]|8[1-6|8|9]|9[0-4|6-9])[0-9]{7}$/;

/**
 * Strong password regex
 * Requirements: uppercase, lowercase, number, special character, 6-20 chars
 */
export const STRONG_PASSWORD_REGEX = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]).{6,20}$/;
