 ...
 * ================================================================ */
export const FONT_SIZE_WHITELIST = new Set<string>(Object.values(tokens.fontSize));

export const SPACE_WHITELIST = new Set<string>([...Object.values(tokens.space), "0", "1px"]);

export const RADIUS_WHITELIST = new Set<string>(Object.values(tokens.radius));
