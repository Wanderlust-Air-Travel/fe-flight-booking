                                                            ...
                                                            <div className="flex flex-col gap-y-[2rem] ">
                                                                ...
                                                                <div className="flex gap-x-[2rem] justify-between items-center">
                                                                    <div className="flex flex-col flex-shrink-0 items-center">
                                                                        <p className={`text-md ${data.typeTicket.includes("Economy") ? "text-[var(--cl-four)]" : "text-[var(--cl-pri)]"} font-bold`}>
                                                                            {startTime}
                                                                        </p>
                                                                    ...
                                                                    <div className="w-full relative h-[0.2rem]">
                                                                        <div className={`w-full h-full border-t-[0.1rem] ${data.typeTicket.includes("Economy") ? "border-[var(--cl-four)]" : "border-[var(--cl-pri)]"} border-dashed `}></div>
                                                                        <div className="absolute bottom-5 left-[50%] -translate-x-1/2">
                                                                            <p className={`text-base ${data.typeTicket.includes("Economy") ? "text-[var(--cl-four)]" : "text-[var(--cl-pri)]"} text-nowrap text-nowrap uppercase font-bold`}>
                                                                                {data.service}
                                                                            </p>
                                                                        </div>
                                                                    ...
                                                                    <div className="flex flex flex-col flex-shrink-0 items-center">
                                                                        <p className={`text-md ${data.typeTicket.includes("Economy") ? "text-[var(--cl-four)]" : "text-[var(--cl-pri)]"} text-center font-bold`}>
                                                                            {endTime}
                                                                        </p>
