...
export function SelectComponent({ placeholder, icon, data,value,onChange }: SelectComponentProp) {
    ...
    return (
        <Select value={value} onValueChange={onChange}>
            <SelectTrigger className="w-full border-none outline-none text-start !h-[4.8rem] shadow-none text-sm sm:text-base md:text-[1.4rem] !text-[var(--cl-pri)] px-2 sm:px-3 md:px-[1rem] select-none">
