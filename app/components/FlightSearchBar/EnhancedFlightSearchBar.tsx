...
import type {
  ...
  SearchOption,
} from "@/types/enhanced-flight-search-bar-type";
...
const EnhancedFlightSearchBar = ({ showTabs = false }: EnhancedFlightSearchBarProps) => {
  ...
  const [activeOption, setActiveOption] = useState<SearchOption>(
    showTabs ? "booking-code" : "flight"
  );
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[var(--cl-pri)]/10 mb-3">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M15 5v2m0 4v2m0 4v2m5-8h2m-2 4h2m-2 4h2M5 5v2m0 4v2m0 4v2M3 9h2m-2 4h2m-2 4h2m5-13h8a1 1 0 011 1v14a1 1 0 01-1 1h-8M5 5H3a1 1 0 00-1 1v14a1 1 0 001 1h2"
                    />
                  </svg>
                </div>
                <Label className="text-lg font-semibold text-[var(--cl-pri)]">Số Vé</Label>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-lg border-2 border-[var(--cl-pri)]/20 shadow-lg p-6 md:p-8">
            <div className="space-y-6">
              <div className="text-center mb-4">
                ...
                <Label className="text-lg font-semibold text-[var(--cl-pri)]">Số Hội Viên</Label>
                <p className="text-sm text-gray-600 mt-1">Nhập số hội viên để tra cứu thông tin</p>
              </div>
              <div>
                <Label htmlFor="membershipNumber" className="text-sm font-medium text-gray-700">
                  Số Hội Viên
                </Label>
                <Input
                  id="membershipNumber"
  ...
  return (
    <div className="w-full">
      {showTabs && (
        <SearchOptionsTabs activeOption={activeOption} onOptionChange={setActiveOption} />
      )}
      <div className={showTabs ? "mt-0" : ""}>{renderSearchForm()}</div>
    </div>
  );
};
