                        ...
                        tickets?.desc?.map((item: { text: string; status: boolean }, index: number) => {
                            return (
                                <li key={index} className="flex gap-x-[0.6rem] sm:gap-x-[0.8rem] items-start">
                                    {
                                        item.status ? <Check className="w-[1.8rem] h-[1.8rem] sm:w-[2.4rem] sm:h-[2.4rem] flex-shrink-0 text-[var(--cl-four)] mt-[0.2rem]" /> :  <X className="w-[1.8rem] h-[1.8rem] sm:w-[2.4rem] sm:h-[2.4rem] flex-shrink-0 text-[var(--cl-red)] mt-[0.2rem]" />
                                    }
