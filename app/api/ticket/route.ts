    ...
    list: [
      {
        ...
        desc: [
          ...
          { text: "Hệ số cộng điểm Bamboo Club: 0.25", status: true },
...

      {
        ...
        desc: [
          ...
          { text: "Hệ số cộng điểm Bamboo Club: 0.5", status: true },
...

      {
        ...
        desc: [
          ...
          { text: "Hệ số cộng điểm Bamboo Club: 1.00", status: true },
    ...
    list: [
      {
        ...
        desc: [
          ...
          { text: "Hệ số cộng điểm Bamboo Club: 1.75", status: true },
          { text: "Chọn ghế ngồi miễn phí", status: true },
          { text: "Không áp dụng cho go-show", status: false },
        ],
      },
