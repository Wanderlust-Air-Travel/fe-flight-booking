...
export const PaymentSchema = Yup.object().shape({
  ...
  address: Yup.string().required(VALIDATION_MESSAGES.PAYMENT.ADDRESS_REQUIRED),

  acceptTerms: Yup.boolean().oneOf([true], VALIDATION_MESSAGES.PAYMENT.ACCEPT_TERMS_REQUIRED),
});
