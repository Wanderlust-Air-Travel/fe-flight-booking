...
import type { CabinClass, CabinService } from "@/types/admin/cabin-service-type";
...
export default function CabinServicesPage() {
  ...
  const [_cabinClasses, setCabinClasses] = useState<CabinClass[]>([]);
  const [_fareClasses, setFareClasses] = useState<FareClass[]>([]);
      ...
      await axiosInstance.post("/api/admin/cabin-services", {
        cabinClassCode:
          formData.cabinClassCode && formData.cabinClassCode !== "none"
            ? formData.cabinClassCode
            : null,
        fareClassCode:
          formData.fareClassCode && formData.fareClassCode !== "none"
            ? formData.fareClassCode
            : null,
        serviceType: formData.serviceType,
        serviceName: formData.serviceName,
        description: formData.description || null,
        isIncluded: formData.isIncluded,
        price: formData.isIncluded
          ? null
          : formData.price
                ...
                <div className="grid gap-6 overflow-y-auto max-h-[calc(90vh-200px)] pr-2">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="grid gap-3">
                      ...
                      >
                        <SelectTrigger className="h-14 text-base">
                          <SelectValue
                            placeholder={loadingDialogData ? "Đang tải..." : "Chọn cabin class"}
                          />
                        </SelectTrigger>
                    ...
                    <div className="grid gap-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFormData({ ...formData, fareClassCode: value })
                        }
                        disabled={
                          !formData.cabinClassCode ||
                          formData.cabinClassCode === "none" ||
                          loadingDialogData
                        }
                      >
                        <SelectTrigger className="h-14 text-base">
                  ...
                  <div className="grid gap-3">
                    ...
                    >
                      ...
                      <SelectContent className="text-base">
                        <SelectItem value="meal" className="text-base py-3">
                          Bữa ăn (Meal)
                        </SelectItem>
                        <SelectItem value="entertainment" className="text-base py-3">
                          Giải trí (Entertainment)
                        </SelectItem>
                        <SelectItem value="wifi" className="text-base py-3">
                          WiFi
                        </SelectItem>
                        <SelectItem value="priority_boarding" className="text-base py-3">
                          Ưu tiên lên máy bay (Priority Boarding)
                        </SelectItem>
                        <SelectItem value="lounge_access" className="text-base py-3">
                          Phòng chờ (Lounge Access)
                        </SelectItem>
                        <SelectItem value="seat_selection" className="text-base py-3">
                          Chọn ghế (Seat Selection)
                        </SelectItem>
                        <SelectItem value="extra_legroom" className="text-base py-3">
                          Chỗ ngồi rộng (Extra Legroom)
                        </SelectItem>
