...
const CheckInPageContent = () => {
  ...
  const [activeTab, setActiveTab] = useState<"booking-code" | "ticket-number" | "membership">(
    "booking-code"
  );
  ...
  const handleMainTabChange = (tab: "book-ticket" | "check-in" | "my-bookings") => {
    ...
    if (tab === "book-ticket") {
      ...
      router.push(localizedHref("/my-bookings", locale));
    }
  };
          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <div className="mt-6 pt-6 border-t">
              <p className="text-sm text-gray-500 text-center mb-2">
                Làm thủ tục trực tuyến chỉ áp dụng cho các chuyến bay nội địa và quốc tế từ các sân
                bay lớn.
              </p>
            </div>
          </div>
