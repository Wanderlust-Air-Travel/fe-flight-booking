...
import { Plus, X, Search, Users, Shield, UserPlus, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function UsersPage() {
    ...
    const filteredUsers = useMemo(() => {
        ...
        return users.filter((user) => {
            ...
            const rolesText = user.roles?.map(r => r.name || r.roleCode || '').join(' ').toLowerCase() || '';
        ...
        <div className="space-y-6">
            ...
            <Card className="border-0 shadow-md">
                <CardHeader className="border-b bg-gray-50/50">
                    <div className="flex items-center justify-between">
                        <div>
                            <CardTitle className="text-2xl font-bold text-gray-900">Danh sách người dùng</CardTitle>
                                            ...
                                            <TableCell className="font-medium text-base">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-10 w-10 rounded-full bg-[#00558f]/10 flex items-center justify-center flex-shrink-0">
                                                        <Users className="h-5 w-5 text-[#00558f]" />
                                                    </div>
                                                    <span className="text-base text-gray-900">{user.email}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell className="text-base text-gray-700">{user.fullname || "-"}</TableCell>
            ...
            <Dialog open={isRoleDialogOpen} onOpenChange={(open) => {
                ...
                <DialogContent className="sm:max-w-[30vw] md:max-w-[30vw] lg:max-w-[30vw] xl:max-w-[40vw] 2xl:max-w-[50vw] 3xl:max-w-[60vw] max-w-2xl max-h-[90vh] overflow-hidden">
                    <DialogHeader>
                        <DialogTitle className="text-3xl font-bold text-gray-900">Gán quyền cho người dùng</DialogTitle>
                        ...
                        <div className="grid gap-3">
                            ...
                            <Select value={selectedRole} onValueChange={setSelectedRole}>
                                ...
                                <SelectContent className="text-base">
                                    {roles
                                        ...
                                        .map((role) => (
                                            <SelectItem key={role.roleCode} value={role.roleCode} className="text-base py-3">
                            ...
                            {roles.filter(
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Người dùng này đã có tất cả các quyền
                                </p>
                            )}
                        </div>
                    </div>
