...
import { Plus, Pencil, Trash2, Search, Plane, CheckCircle2, XCircle, Calendar as CalendarIcon, Clock, ChevronLeft, ChevronRight } from "lucide-react";
...
const formatOperatingDays = (days: string) => {
    ...
    const activeDays = days.split('').map((d, i) => d === '1' ? dayNames[i] : null).filter(Boolean);
        ...
        <div className="space-y-6">
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900 mt-1">{totalItems.toLocaleString('vi-VN')}</p>
                            </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
                        ...
                        <Dialog open={isCreateDialogOpen} onOpenChange={(open) => {
                            ...
                            <DialogContent className="sm:max-w-[90vw] md:max-w-[80vw] lg:max-w-[70vw] xl:max-w-[60vw] 2xl:max-w-[50vw] 3xl:max-w-[60vw] max-w-5xl max-h-[90vh] overflow-hidden">
                                <DialogHeader>
                                    <DialogTitle className="text-3xl font-bold text-gray-900">Thêm lịch chuyến bay mới</DialogTitle>
                                ...
                                <div className="grid gap-6 overflow-y-auto max-h-[calc(90vh-200px)] pr-2">
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        >
                                            ...
                                            <SelectContent className="text-base">
                                                {routes.map((route) => {
                                                    const origin = route.origin_airport?.city || route.originAirport?.city || 'N/A';
                                                    const dest = route.destination_airport?.city || route.destinationAirport?.city || 'N/A';
                                                    return (
                                                        <SelectItem key={route.route_id || route.routeId} value={route.route_id || route.routeId} className="text-base py-3">
                                                            {origin} → {dest}
                                                        </SelectItem>
                                                    );
                                                })}
                                    ...
                                    <div className="grid gap-3">
                                        <Label htmlFor="aircraftTypeId" className="text-base font-semibold text-gray-700">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="grid gap-3">
                                            <Label htmlFor="departureTime" className="text-base font-semibold text-gray-700">
                                        ...
                                        <div className="grid gap-3">
                                            <Label htmlFor="arrivalTime" className="text-base font-semibold text-gray-700">
                                    ...
                                    <div className="grid gap-3">
                                        <Label htmlFor="operatingDays" className="text-base font-semibold text-gray-700">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Ví dụ: 1111111 = Tất cả các ngày, 1111100 = Thứ 2-6 (7 ký tự: 0=Chủ nhật, 1=Thứ 2...)
                                        </p>
                                    </div>
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="grid gap-3">
            ...
            <Card className="border-0 shadow-md">
                <CardHeader className="border-b bg-gray-50/50">
                    <div className="flex items-center justify-between">
                        <div>
                            <CardTitle className="text-2xl font-bold text-gray-900">Danh sách lịch chuyến bay</CardTitle>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-gray-50 hover:bg-gray-50">
                                    ...
                                    <TableHead className="font-semibold text-gray-700 text-base">Loại máy bay</TableHead>
                                    <TableHead className="font-semibold text-gray-700 text-base">Giờ khởi hành</TableHead>
                                    <TableHead className="font-semibold text-gray-700 text-base">Giờ đến</TableHead>
                                    <TableHead className="font-semibold text-gray-700 text-base">Ngày hoạt động</TableHead>
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={(open) => {
                ...
                <DialogContent className="sm:max-w-[100vw] md:max-w-[90vw] lg:max-w-[80vw] xl:max-w-[70vw] 2xl:max-w-[60vw] 3xl:max-w-[70vw] max-w-5xl max-h-[90vh] overflow-hidden">
                    <DialogHeader>
                        <DialogTitle className="text-3xl font-bold text-gray-900">Chỉnh sửa lịch chuyến bay</DialogTitle>
                        <DialogDescription className="text-base text-gray-600 mt-2">
                    ...
                    <div className="grid gap-6 overflow-y-auto max-h-[calc(90vh-200px)] pr-2">
                        <div className="grid grid-cols-2 gap-6">
                            <div className="grid gap-3">
                                <Label htmlFor="edit-departureTime" className="text-base font-semibold text-gray-700">
                                    Giờ khởi hành (HH:mm) <span className="text-red-500 ml-1">*</span>
                                </Label>
                                <Input
                        ...
                        <div className="grid gap-3">
                            ...
                            >
                                ...
                                <SelectContent className="text-base">
                                    ...
                                    <SelectItem value="inactive" className="text-base py-3">Không hoạt động</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
