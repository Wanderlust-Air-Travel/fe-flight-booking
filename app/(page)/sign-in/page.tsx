...
const SignInPage = () => {
    ...
    const handleDirectLogin = useCallback(async (email: string, password: string) => {
        try {
                                                ...
                                                <div className="flex flex-col gap-y-[3.2rem]">
                                                    ...
                                                    <div className="flex flex-col gap-y-[1.2rem] relative">
                                                        ...
                                                        <p className="text-mn text-[var(--cl-pri)] text-center">
                                                            You do not have an account, please <Link className="text-[var(--cl-four)] hover:underline transition underline-offset-2" href="/sign-up">register</Link> now
                                                        </p>
                                                    </div>
                                                </div>
                                            </form>
