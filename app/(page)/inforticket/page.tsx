                                    ...
                                    <div className="flex flex-col gap-y-[2rem]">
                                        <label htmlFor="acceptTerms" className="flex gap-3 items-start select-none relative">
                                            ...
                                            <p className="text-[var(--cl-pri)] text-base">
                                                ...
                                                <Link className="text-[var(--cl-five)]" href="/" > Privacy Policy</Link>,<Link className="text-[var(--cl-five)]" href="/" >Terms of Use for Online Booking Function</Link> and <Link className="text-[var(--cl-five)]" href="/">Website Terms of Use</Link>
                                            </p>
                                        ...
                                        <div className="flex gap-x-[1.2rem]">
                                            ...
                                            <Button className="w-[50%] px-[2rem] h-[4.4rem] bg-[var(--cl-pri)] text-[1.6rem] uppercase hover:bg-[var(--cl-four)]" type="submit"  onClick={handleConfỉm} >Confirm</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
